package com.study.attendance.exception;


import com.study.attendance.utils.JsonUtil;
...
public class GlobalExceptionHandler {
    ...
    public void baseRuntimeExceptionHandle(HttpServletRequest request, BaseRuntimeException e) {
        ...
        try {
            JsonUtil.writeErrorResponse(e.getCode(), Arrays.asList(e.getCode()), e.getStatus());
        } catch (IOException e1) {
